...
function depo_square_register_widgets() {
	register_widget( 'Widget_DePoFlickr' );
	wp_register_sidebar_widget( 'depo-square-about', __( 'DePo Square About', 'depo-square' ), 'depo_square_about_widget' );
	wp_register_sidebar_widget( 'depo-square-status', __( 'DePo Square Status', 'depo-square' ), 'depo_square_status_widget' );
}
add_action( 'widgets_init', 'depo_square_register_widgets' );

function depo_square_register_sidebars() {
	register_sidebar( array(
		'name'          => __( 'Left', 'depo-square' ),
...
add_action( 'widgets_init', 'depo_square_register_sidebars' );
