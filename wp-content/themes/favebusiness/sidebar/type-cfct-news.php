...
<div id="sidebar" class="c6-56">
	...
	<aside class="widget">
		...
		<p><?php printf(__('It looks like you haven&rsquo;t added any widgets to this sidebar yet. To customize this sidebar (News Sidebar), go <a href="%s">add some</a>!', 'favebusiness'), admin_url('widgets.php')); ?></p>
	</aside>
	<?php
	}
	?>
