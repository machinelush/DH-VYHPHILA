# Welcome to FaveBusiness


A premium theme with advanced drag-and-drop page layout features.

FaveBusiness supports many advanced features, including Child 
Theming, Custom Post Types, Nav Menus, AJAX Archives, and a whole lot more.


For documentation on supported features go to:

http://crowdfavorite.com/wordpress/themes/favebusiness/docs/


For support, please visit our customer forums:

http://crowdfavorite.com/forums/forum/favebusiness-theme


# Carrington Core Theme Platform for WordPress
